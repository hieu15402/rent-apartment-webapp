...
import com.example.rentapartmentwebapp.dto.PostDTO;
import com.example.rentapartmentwebapp.models.Post;
...
public interface PostRepository extends JpaRepository<Post,Long> {
    @Query("SELECT NEW com.example.rentapartmentwebapp.dto.PostDTO(p.title, p.description, a.id) " +
            "FROM Post p " +
            "JOIN p.apartment a ")
